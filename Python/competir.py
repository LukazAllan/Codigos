...
#     ['Shinichi', 0, 'M'],['Fuyuki', 0, 'M'],['Yoshi', 0, 'M'],['Yoshiyuki', 0, 'M'],
#     ['Kanji', 0, 'M'], [' Tsukasa', 0, 'M'],['Hayato', 0, 'M'],

#     ['Hana', 0, 'F'],['Sakura', 0, 'F'],['Hifumi', 0, 'F'],['Ako', 0, 'F'],
#     ['Kohaku', 0, 'F'],['Uzaki', 0, 'F'],['Kou', 0, 'F'], ['Uzaki', 0, 'F'],
#     ['Umiko', 0, 'F'], ['Aoba', 0, 'F'], ['Megumin', 0, 'F'],['Takagi', 0, 'F'],
#     ['Yun', 0, 'F'],['Ayumi', 0, 'F'],['Nene', 0, 'F'],['Rin', 0, 'F'],
#     ['Hajime', 0, 'F'],['Megumin', 0, 'F'],
