...
for c in range(0, 2):
    ...
    if 'u' in i.lower():
        ...
        req.urlretrieve(
            'https://drive.google.com/uc?authuser=0&id=1v-BbhiTD_1pATcrLNttVK0C_akUVnl-l&export=download',
            'data1.csv')
        abre(slot=c)
    if c == 0:
...
if not slot:
    for a in range(-1, len(data_cont[0])):
        if a == -1:
            ...
            print(
                f"{(a + 1) :>2}|{data_cont[0][a]['nivel']:>2}|{data_cont[0][a]['nome']:>17}|{data_cont[0][a]['pvt'] :>2}|{data_cont[0][a]['pa']:>2}|{data_cont[0][a]['s']}|{(data_cont[0][a]['pv'] + data_cont[0][a]['s'] + data_cont[0][a]['pa'])}"
            )
    for a in range(1, 3):
        while True:
            if a == 1:
                imp = input(
                    f'{J1[0]} escolha teus personagens\n(Separe por vírgula, 0 - tudo)\n'
                )

            elif a == 2:
                imp = input(
                    f'{J2[0]} escolha teus personagens\n(Separe por vírgula, 0 - tudo)\n'
                )
            esc = imp.strip().split(',')
            n = False
            if imp == '':
    ...
    for a in range(-1, len(data_cont[1])):
        ...
        #print(emoji.emojize(f" *|Nv|{'Nome' :>17}|\033[31m:heart:\033[m|\033[31m:fire:\033[m|\033[32m:four_leaf_clover:\033[m|", use_aliases=True))
            ...
            print(
                f"{(a + 1) :>2}|{data_cont[1][a]['nivel']:>2}|{data_cont[1][a]['nome']:>17}|{data_cont[1][a]['pvt'] :>2}|{data_cont[1][a]['pa']:>2}|{data_cont[1][a]['s']}|{(data_cont[1][a]['pv'] + data_cont[1][a]['s'] + data_cont[1][a]['pa'])}"
            )
    while True:
        imp = input(
            f'{J1[0]} escolha teus personagens\n(Separe por vírgula, 0 - tudo)\n'
...
def Print():
    ...
    if a[0] >= 60 and a[1] <= 40:
        if a[0] != 100:
            if a[0] <= 90:
                print(
                    f"\033[7;32m{'Ganhando':>17} {a[0] :.2f}%\033[m{' ' * 7}\033[7;31m{a[1] :.2f}%{' ' * 18}\033[m"
                )
                print(
                    f"\033[7;32m{J1[0]:>24}\033[m{' ' * 7}\033[7;31m{J2[0]:<24}\033[m"
                )
            else:
                print(
                    f"\033[7;32m{'Ganhando':>17} {a[0] :.2f}%\033[m{' ' * 7}\033[7;31m{a[1] :.2f}%{' ' * 19}\033[m"
                )
                print(
                    f"\033[7;32m{J1[0]:>24}\033[m{' ' * 7}\033[7;31m{J2[0]:<24}\033[m"
                )
            ...
            print(
                f"\033[7;32m{'Ganhou':>16} {a[0] :.2f}%\033[m{' ' * 7}\033[7;31m{a[1] :.2f}%{' ' * 19}\033[m"
            )
            print(
                f"\033[7;32m{J1[0]:>24}\033[m{' ' * 7}\033[7;31m{J2[0]:<24}\033[m"
            )
        ...
        if a[1] != 100:
            print(
                f"\033[7;31m{a[0] :>23.2f}%\033[m{' ' * 7}\033[7;32m{a[1] :<4.2f}% Ganhando{' ' * 9}\033[m"
            )
            print(
                f"\033[7;31m{J1[0]:>24}\033[m{' ' * 7}\033[7;32m{J2[0]:<24}\033[m"
            )
        else:
            print(
                f"\033[7;31m{a[0] :>23.2f}%\033[m{' ' * 7}\033[7;32m{a[1] :<4.2f}% Ganhou{' ' * 10}\033[m"
            )
            print(
                f"\033[7;31m{J1[0]:>24}\033[m{' ' * 7}\033[7;32m{J2[0]:<24}\033[m"
            )
    ...
    if len(J1) == len(J2):
        for c in range(1, len(J1)):
            if J1[c]['pv'] > (2 * J1[c]['pvt'] / 3):
                print(
                    f"\033[7;32m{J1[c]['nome'] :>17} {J1[c]['pa']:>2} {J1[c]['pv'] :>3}\033[m  {c :>2}   ",
                    end='')
            elif (J1[c]['pvt'] / 3) < J1[c]['pv'] <= (2 * J1[c]['pvt'] / 3):
                print(
                    f"\033[7;33m{J1[c]['nome'] :>17} {J1[c]['pa']:>2} {J1[c]['pv'] :>3}\033[m  {c :>2}   ",
                    end='')
            elif 0 < J1[c]['pv'] <= (J1[c]['pvt'] / 3):
                print(
                    f"\033[7;31m{J1[c]['nome'] :>17} {J1[c]['pa']:>2} {J1[c]['pv'] :>3}\033[m  {c :>2}   ",
                    end='')
            elif J1[c]['pv'] == 0:
                print(
                    f"\033[7;30m{J1[c]['nome'] :>17} {J1[c]['pa']:>2} {J1[c]['pv'] :>3}\033[m  {c :>2}   ",
                    end='')
            if J2[c]['pv'] > (2 * J2[c]['pvt'] / 3):
                print(
                    f"\033[7;32m{J2[c]['pv'] :<3} {J2[c]['pa']:>2} {J2[c]['nome'] :<17}\033[m"
                )
            elif (J2[c]['pvt'] / 3) < J2[c]['pv'] <= (2 * J2[c]['pvt'] / 3):
                print(
                    f"\033[7;33m{J2[c]['pv'] :<3} {J2[c]['pa']:>2} {J2[c]['nome'] :<17}\033[m"
                )
            elif 0 < J2[c]['pv'] <= (J2[c]['pvt'] / 3):
                print(
                    f"\033[7;31m{J2[c]['pv'] :<3} {J2[c]['pa']:>2} {J2[c]['nome'] :<17}\033[m"
                )
            elif J2[c]['pv'] == 0:
                print(
                    f"\033[7;30m{J2[c]['pv'] :<3} {J2[c]['pa']:>2} {J2[c]['nome'] :<17}\033[m"
                )
        ...
        if len(J1) > len(J2):
            ...
            for a in range(len(J2), len(J1)):
                if J1[a]['pv'] > (2 * J1[a]['pvt'] / 3):
                    print(
                        f"\033[7;32m{J1[a]['nome'] :>17} {J1[a]['pa']:>2} {J1[a]['pv'] :>3}\033[m  {a :>2}   "
                    )
                elif (J1[a]['pvt'] / 3) < J1[a]['pv'] <= (
                        2 * J1[a]['pvt'] / 3):
                    print(
                        f"\033[7;33m{J1[a]['nome'] :>17} {J1[a]['pa']:>2} {J1[a]['pv'] :>3}\033[m  {a :>2}   "
                    )
                elif 0 < J1[a]['pv'] <= (J1[a]['pvt'] / 3):
                    print(
                        f"\033[7;31m{J1[a]['nome'] :>17} {J1[a]['pa']:>2} {J1[a]['pv'] :>3}\033[m  {a :>2}   "
                    )
                elif J1[a]['pv'] == 0:
                    print(
            ...
            for a in range(len(J1), len(J2)):
                if J2[a]['pv'] > (2 * J2[a]['pvt'] / 3):
                    print(
                        f"{'' :>26}{a :>2}   \033[7;32m{J2[a]['pv'] :<3} {J2[a]['pa']:>2} {J2[a]['nome'] :<17}\033[m"
                    )
                elif (J2[a]['pvt'] / 3) < J2[a]['pv'] <= (
                        2 * J2[a]['pvt'] / 3):
                    print(
                        f"{'' :>26}{a :>2}   \033[7;33m{J2[a]['pv'] :<3} {J2[a]['pa']:>2} {J2[a]['nome'] :<17}\033[m"
                    )
                elif 0 < J2[a]['pv'] <= (J2[a]['pvt'] / 3):
                    print(
                        f"{'' :>26}{a :>2}   \033[7;31m{J2[a]['pv'] :<3} {J2[a]['pa']:>2} {J2[a]['nome'] :<17}\033[m"
                    )
                elif J2[a]['pv'] == 0:
                    print(
                        f"{'' :>26}{a :>2}   \033[7;30m{J2[a]['pv'] :<3} {J2[a]['pa']:>2} {J2[a]['nome'] :<17}\033[m"
                    )
...
while True:
    ...
    if com[0] == 'sub':
        ...
        if sel != ['nulo']:
            ...
            print(
                'Selecione primeiro, antes de substituí-lo\ncomando: sel (Jogador 1) (Jogador 2)'
            )
    if 'atq' == com[0]:
        try:
            if com[1] == 'j1':
                if J1[sel[1]]['pv'] != 0:
                    ...
                    print(
                        f'{J1[sel[1]]["nome"]} tem 0 de vida, não pode atacar')
                sorte = [
                ...
                if J2[sel[2]]['pv'] != 0:
                    ...
                    print(
                        f'{J2[sel[2]]["nome"]} tem 0 de vida, não pode atacar')
            elif com[1] == 'j2':
                if J2[sel[2]]['pv'] != 0:
                    # print('estou dentro')
                    for c in range(0, (J1[sel[1]]['s'] + 1)):
            ...
            print(
                'Ou você ainda não selecionou os personagens, ou você esqueceu que tem que especificar quem ataca\ncomando: sel (Jogador 1) (Jogador 2)'
            )
    if com[0] == 'sair':
        break
    if com[0] == 'sudo':
        if com[1] == 'hp':
            if com[2] == 'j1' and bool(com[3]) == True and bool(
                    com[4]) == True:
                # sudo hp j1 1 100
                com[4]: int = int(com[4])
                com[3]: int = int(com[3])
                J1[com[3]]['pv'] += com[4]
            if com[2] == 'j2' and bool(com[3]) == True and bool(
                    com[4]) == True:
                # sudo hp j2 1 100
                com[4]: int = int(com[4])
                com[3]: int = int(com[3])
            ...
            try:
                if com[2] == 'j1' and bool(com[3]) and bool(com[4]) and bool(
                        com[5]):
                    # sudo atq j1 100 1 1
                    com[4]: int = int(com[4])
                    com[5]: int = int(com[5])
                    if J2[com[5]]['pv'] != 0:
                        ...
                        pass
                if com[2] == 'j2' and bool(com[3]) and bool(com[4]) and bool(
                        com[5]):
                    # sudo atq j2 100 1 1
                    com[4]: int = int(com[4])
                    com[5]: int = int(com[5])
                ...
                try:
                    ...
                    print(
                        'Você ainda não selecionou os personagens\ncomando: sel (Jogador 1) (Jogador 2)'
                    )
